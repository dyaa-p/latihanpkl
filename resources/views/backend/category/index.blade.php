...
@section('styles')
<link rel="https://cdn.datatables.net/2.3.2/css/dataTables.bootstrap5.css">
@endsection
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('backend.category.destroy', $data->id) }}" class="btn btn-sm brn-danger" dta-confirm-delete='true'>
                                            Delete
                                        </a>
                                    </td>
                                </tr>
